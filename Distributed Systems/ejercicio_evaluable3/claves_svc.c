...
int
_set_value_1 (request  *argp, void *result, struct svc_req *rqstp)
{
...
int
_modify_value_1 (request  *argp, void *result, struct svc_req *rqstp)
{
...
{
	union {
		request set_value_1_arg;
		int get_value_1_arg;
		request modify_value_1_arg;
		int delete_key_1_arg;
		int exist_1_arg;
	} argument;
	union {
		int set_value_1_res;
		get_response get_value_1_res;
