...
class RegistroUsuario:
    def __init__(self, usuario, password, password2, nombre, apellido1, apellido2, mail, centro_medico):
        ...
        # Inicializamos la Autoridad Certificadora (AC1)
        #self.ac1_nombre = "Gestor Médico AC1"
        #self.ac1_clave_privada, self.ac1_certificado = self.__generar_certificado_ac1()
    ...
    def registrar_usuario(self):
        ...
        # Generar certificado del usuario
        #certificado_usuario = self.__generar_certificado_usuario(self.__usuario)
        ...
        nuevo_usuario = {
            ...
            "mail": self.__mail,
            "centro_medico": self.__centro_medico,
            #"certificado": self.__generar_certificado_usuario(self.__usuario)
            "certificado":"certificados/"+self.__usuario+ "_cert.pem"
            #certificado_usuario
            #self.__generar_certificado(self.__usuario) # cada usuario registrado tiene un certificado único
